-- RSVP-gated map event linking on connection encounters (mirrors click-web).
...
COMMENT ON COLUMN public.connection_encounters.event_beacon_id IS
  'Map event beacon when both parties RSVPed and connected at live place/time; distinct from events_registry event_id.';
