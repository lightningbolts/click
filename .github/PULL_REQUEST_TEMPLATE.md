...
- [ ] Android — Home (pile or list with visible cards)
- [ ] Android — Add Click (+ My QR or Tap if opened)
- [ ] Android — Clicks, including an open chat if reachable
- [ ] Android — Map, including at least one uploaded-photo beacon pin clipped to the marker shape
- [ ] Android — Settings, including a nested sub-screen
...
- [ ] Device/emulator: body content visible on Home / Clicks / Settings; tab bar unchanged
- [ ] Android validation covers changed loading, empty, offline, error, permission-denied, keyboard, back-navigation, and restoration states
