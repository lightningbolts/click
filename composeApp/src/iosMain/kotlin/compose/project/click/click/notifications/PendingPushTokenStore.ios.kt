...
private fun legacyPendingPushTokenKey(tokenType: String): String = "pending_push_token_$tokenType"

private fun legacyPendingPushPlatformKey(tokenType: String): String = "pending_push_platform_$tokenType"

actual fun savePendingPushToken(
    token: String,
    platform: String,
    tokenType: String,
) {
...
private fun setKeychainPushEntry(
    tokenType: String,
    value: String,
): Boolean {
...
@OptIn(ExperimentalForeignApi::class, kotlinx.cinterop.BetaInteropApi::class)
private fun getKeychainPushEntry(tokenType: String): String? =
    memScoped {
        val query =
            mapOf<Any?, Any?>(
                kSecClass to kSecClassGenericPassword,
