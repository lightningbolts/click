...
actual object PlatformCrypto {
    ...
    actual fun aesGcmEncrypt(
        ...
        plaintext: ByteArray,
    ): ByteArray = aesGcm(Cipher.ENCRYPT_MODE, key, nonce, additionalData, plaintext)
    ...
    ): ByteArray = aesGcm(Cipher.DECRYPT_MODE, key, nonce, additionalData, ciphertextAndTag)
