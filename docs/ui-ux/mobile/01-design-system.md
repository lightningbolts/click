...
- **Section labels:** one shared `SectionHeader` (bold title, optional caption, optional trailing action) for every Home, saved-events, and Explore list section. Do not overlay a section label on top of the cards it labels.
