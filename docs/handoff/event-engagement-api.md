...
Explicit `check_in_radius_meters` clamped **[25, 5000]**. Pin near gathering **center**. Live window = schedule `isLive` + **15 min** early grace. Errors: 400 location / 403 out of bounds / 409 not live.
